                ...
                <div class="card-box">
                    ...
                    <table id="grid" class="table-bordered"
                        ...
                        <tr class="">
                            ...
                            <th data-field="name" data-sortable="false" data-formatter="link" >Ten
                            </th>
                            ...
                            @if(Auth::user()->can('ds-product'))
                                <th data-field="ship" data-sortable="false" class="text-right">Phí ship HN</th>
                                <th data-field="weight" data-sortable="false">Khối lượng</th>
                                <th data-field="total" data-sortable="false" class="text-right">Tổng vnđ</th>
                            @endif
                            <th data-field="status" data-sortable="false">Trạng thái</th>
                            <th data-field="transporters" data-sortable="false">Nhà vận chuyển</th>
                            <th data-field="transport_code" data-sortable="false">Mã vận chuyển</th>
