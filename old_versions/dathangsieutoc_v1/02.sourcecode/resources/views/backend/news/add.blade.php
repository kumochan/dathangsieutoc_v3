...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form method="post" class="form-add" action="{{ action('Backend\NewsController@add') }}">
            {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-6">
                                <input type="text" id="title" name="title" value="{{ old('title') }}" parsley-trigger="change" required placeholder="Tiêu đề" class="form-control">
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-6">
                                <textarea id="excerpt" name="excerpt" class="form-control" rows="3" placeholder="Tóm tắt">{{ old('excerpt') }}</textarea>
                            </div>
                            <div class="col-lg-3">
