            ...
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ action('Backend\NewsController@index') }}">Bài viết</a></li>
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            @if ((!Auth::user()->can('add-category') and !Auth::user()->can('add-category')))
            $('.col-form').remove();
            $('.col-grid').removeClass('col-lg-8').addClass('col-lg-12');
            @endif

            @if (Auth::user()->can('add-category') and $term->id <= 0)
