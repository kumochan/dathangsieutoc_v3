...
class UserController extends Controller
{
    ...
    public function delete(Request $request){
        ...
        try {
            ...
            DB::table('users_roles')->whereIn('user_id', $ids)->delete();
            // 02. Xoa du lieu bang roles_permissions
            DB::table('users_permissions')->whereIn('user_id',$ids)->delete();
    ...
    {
        $user = User::getUserByRoles('nguoi-dung');
        $result = collect($user)->map(function ($item) {
