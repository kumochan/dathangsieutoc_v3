        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="btn-group pull-right m-t-15">
                    <a href="{{ action('Backend\MenuController@showAddForm') }}" class="btn btn-default">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ action('Backend\RoleController@index') }}">Danh sách menu</a>
                    </li>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <table id="grid" class="table-bordered "
                           ...
                           data-url="{{ action('Api\MenuController@grid') }}"
                        ...
                        <tr>
                            ...
                            <th data-field="title" data-sortable="title">Tên menu</th>
                            <th data-field="menu_item_slug" data-sortable="false">Khoá thay thế</th>
...
@section('javascript')
    ...
    <script>
        ...
        //     pageList: [10, 25, 50, 75, 100]//list of page sizes
        // });
        //
        // function queryParams(offset, limit, search) {
        //     return {
        //         type: 'owner',
        //         sort: 'updated',
        //         direction: 'desc',
        ...
        $(document).ready(function () {
            ...
            $('.form-delete').on('click', function () {
                ...
                $.ajax({
                    url: '{{ action('Api\MenuController@delete') }}', type: 'POST', dataType: 'JSON',
                    headers: {
        ...
        function gridAction(value, row) {
            ...
            @if(Auth::user()->can('edit-role'))
                actions += '<a href="{{ action('Backend\MenuController@showEditForm', array('id'=>'')) }}/' + row.id + '" class="on-default edit-row text-primary"><i class="fa fa-pencil"></i></a> ';
            @endif
