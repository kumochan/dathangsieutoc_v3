        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="btn-group pull-right m-t-15">
                    <a href="{{ action('Backend\CustomerController@getAdd') }}" class="btn btn-default">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{ action('Backend\CustomerController@index') }}">Danh sách khách hàng</a>
                    </li>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <table id="grid" class="table-bordered "
                           ...
                           data-page-size="3"
                           data-page-list="[3, 6, 8, 30, 50]"
                           data-url="{{ action('Api\CustomerController@grid') }}"
                        ...
                        <tr>
                            ...
                            <th data-field="customer_id" data-sortable="false">ID</th>
                            <th data-field="customer_name" data-sortable="false">Tên</th>
                            <th data-field="phone" data-sortable="false">SĐT</th>
                            <th data-field="email" data-sortable="false">Email</th>

                            <th data-field="customer_id" data-formatter="gridAction">Hành động</th>
                        </tr>
                        </thead>
                    </table>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.form-delete').on('submit', function () {
                ...
                $.ajax({
                    url: '{{ action('Backend\CustomerController@delete') }}', type: 'POST', dataType: 'JSON',
                    data: $(this).serialize(),
        ...
        function gridAction(value, row) {
           ...
           // console.log(array('id'));
            @if(Auth::user()->can('edit-customer'))
                actions += '<a href="{{ action('Backend\CustomerController@getEdit', array('id'=>'')) }}/' + row.customer_id + '" class="on-default edit-row text-primary"><i class="fa fa-pencil"></i></a> ';
            @endif
                @if(Auth::user()->can('delete-customer'))
                actions += '<a href="javascript:;" class="on-default remove-row text-danger grid-btn-delete" data-id="' + row.customer_id + '" data-toggle="modal" data-target=".modal-delete"><i class="fa fa-trash-o"></i></a> ';
            @endif
